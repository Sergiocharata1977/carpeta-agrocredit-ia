...
export default function LandingPage() {
  ...
  const headerBg = useTransform(scrollY, [0, 80], ["rgba(250,248,255,0)", "rgba(250,248,255,0.92)"])
  const headerShadow = useTransform(scrollY, [0, 80], ["0 0 0 0 transparent", "0 1px 0 0 #ddd6fe"])

  return (
    <div style={{ background: "#faf8ff", fontFamily: "'Inter',system-ui,sans-serif", color: "#212529" }}>
      <style>{`
        ...
        <div className="mx-auto flex h-[68px] max-w-[1180px] items-center justify-between px-7">
          ...
          <nav className="hidden items-center gap-[30px] md:flex">
            {[["Beneficios","#beneficios"],["Proceso","#proceso"],["Roles","#roles"],["Métricas","#metricas"]].map(([l, h]) => (
              <a key={l} href={h} className="text-[14.5px] font-medium text-[#5A6470] transition-colors hover:text-[#6d28d9]">{l}</a>
            ))}
            <Link href="/registro"
              className="rounded-[11px] bg-[#6d28d9] px-5 py-2.5 text-[14.5px] font-semibold text-white shadow-[0_6px_16px_rgba(109,40,217,.28)] transition hover:-translate-y-0.5 hover:bg-[#4c1d95]">
              Registrate gratis
            </Link>
          </nav>
        </div>
      ...
      <section className="overflow-hidden py-[74px]"
        style={{ background: "radial-gradient(1100px 520px at 88% -10%,rgba(139,92,246,.16),transparent 60%),radial-gradient(900px 480px at -5% 30%,rgba(91,33,182,.10),transparent 55%),#faf8ff" }}>
        <div className="mx-auto grid max-w-[1180px] grid-cols-1 items-center gap-14 px-7 lg:grid-cols-2">
          ...
          <motion.div variants={stagger(0.1)} initial="hidden" animate="show" className="flex flex-col">
            <motion.span variants={fadeUp}
              className="mb-5 inline-flex w-fit items-center gap-2 rounded-full border border-[#ddd6fe] bg-[#f0ebff] px-3.5 py-1.5 text-[12.5px] font-semibold text-[#6d28d9]">
            ...
            <motion.h1 variants={fadeUp}
              ...
              De tu negocio al{" "}
              <span style={{ background: "linear-gradient(120deg,#6d28d9,#a78bfa)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", backgroundClip: "text" }}>
                crédito aprobado
              </span>
              , sin demoras
            </motion.h1>
            ...
            <motion.div variants={fadeUp} className="flex flex-col gap-4">
              <div className="flex flex-wrap gap-3.5">
                <Link href="/registro"
                  className="inline-flex items-center gap-2 rounded-[13px] bg-[#6d28d9] px-6 py-[15px] text-[15.5px] font-semibold text-white shadow-[0_6px_16px_rgba(109,40,217,.28)] transition hover:-translate-y-0.5 hover:bg-[#4c1d95]">
                  Registrate gratis
                ...
                <Link href="/login"
                  className="inline-flex items-center gap-2 rounded-[13px] border border-[#ede9fe] bg-white px-6 py-[15px] text-[15.5px] font-semibold text-[#212529] shadow-sm transition hover:-translate-y-0.5 hover:border-[#a78bfa] hover:text-[#6d28d9]">
                  Ya tengo cuenta
                </Link>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {[
                  { label: "Cliente / Productor", href: "/registro/usuario", color: "#6d28d9", bg: "#f0ebff", border: "#ddd6fe" },
                  { label: "Contador",             href: "/registro/contador", color: "#312e81", bg: "#eef2ff", border: "#c7d2fe" },
                  { label: "Entidad Financiera",   href: "/registro/entidad",  color: "#7e22ce", bg: "#f3e8ff", border: "#e9d5ff" },
                ].map((r) => (
            ...
            <motion.div variants={fadeUp} className="mt-8 flex flex-wrap gap-5">
              {[
                ...
                <span key={t.label} className="flex items-center gap-2 text-[13.5px] font-medium text-[#5A6470]">
                  <svg viewBox="0 0 24 24" fill="none" stroke="#6d28d9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-[17px] h-[17px] shrink-0">{t.d}</svg>
                  {t.label}
                </span>
              ))}
            </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: 48 }} animate={{ opacity: 1, x: 0 }}
            ...
            className="rounded-[20px] border border-[#ede9fe] bg-white p-[30px] shadow-[0_18px_50px_rgba(91,33,182,.1),0_6px_16px_rgba(91,33,182,.06)]">
            <div className="mb-6 flex items-center justify-between">
              <span className="text-[12px] font-bold uppercase tracking-[.12em] text-[#8A93A0]">Flujo Legajo</span>
              <span className="flex items-center gap-1.5 text-[12px] font-semibold text-[#6d28d9]">
                <span className="dot-pulse h-[7px] w-[7px] rounded-full bg-[#a78bfa]"/>En vivo
              </span>
            </div>

            <div className="flex items-start justify-between">
              {[
                { name: "Productor\n/ PyME", desc: "Produce y necesita financiamiento", bg: "#f0ebff", color: "#6d28d9", border: "#ddd6fe",
                ...
                { name: "Contador", desc: "Ordena y carga la documentación", bg: "#eef2ff", color: "#312e81", border: "#c7d2fe",
                ...
                { name: "Banco", desc: "Recibe la carpeta y aprueba", bg: "#f3e8ff", color: "#7e22ce", border: "#e9d5ff",
            ...
            <div className="mt-6 flex gap-4">
              {[0,1].map((i) => (
                <div key={i} className="relative h-0.5 flex-1" style={{ background: "#ede9fe" }}>
                  <div className="connector-pulse"
                    style={{ background: i === 0 ? "#a78bfa" : "#4f46e5", boxShadow: i === 0 ? "0 0 0 4px rgba(167,139,250,.2)" : "0 0 0 4px rgba(99,102,241,.2)", animationDelay: i === 0 ? "0s" : "1.3s" }}/>
                </div>
              ))}
            </div>

            <div className="mt-5 flex items-center justify-between border-t border-dashed border-[#ede9fe] pt-4">
      ...
      {/* ── FLUJO ANIMADO ─────────────────────────────────────────────────── */}
      <section id="flujo" className="border-y border-[#ede9fe] py-[88px]"
        style={{ background: "linear-gradient(160deg,#f5f0ff 0%,#eef2ff 50%,#f3e8ff 100%)" }}>
        <div className="mx-auto max-w-[1180px] px-7">
          <motion.div variants={stagger(0.08)} initial="hidden" whileInView="show"
            viewport={{ once: true, margin: "-60px" }} className="mb-10 text-center">
            <motion.span variants={fadeUp}
              className="mb-3 inline-block text-[12px] font-bold uppercase tracking-[.12em] text-[#6d28d9]">
              Cómo funciona
            </motion.span>
            <motion.h2 variants={fadeUp}
              className="text-[clamp(26px,3.4vw,36px)] font-extrabold leading-[1.1] tracking-[-0.03em] text-[#1e1b4b]">
      ...
      <section id="beneficios" className="bg-white py-[88px]">
        <div className="mx-auto max-w-[1180px] px-7">
          <motion.div variants={stagger(0.08)} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} className="mb-12 text-center">
            <motion.span variants={fadeUp} className="mb-3.5 inline-block text-[12px] font-bold uppercase tracking-[.12em] text-[#6d28d9]">El cambio</motion.span>
          ...
          <div className="grid grid-cols-1 items-stretch gap-5 md:grid-cols-[1fr_84px_1fr]">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.6 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.5, delay: 0.2, ease: EASE }} viewport={{ once: true }}
              ...
              <div className="flex h-16 w-16 items-center justify-center rounded-full border border-[#ede9fe] bg-white text-[#6d28d9] shadow-[0_18px_50px_rgba(91,33,182,.1)]">
            ...
            <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, ease: EASE }} viewport={{ once: true }}
              className="rounded-[20px] border border-[#ddd6fe] p-8" style={{ background: "linear-gradient(160deg,#f5f0ff,#ede9fe)" }}>
              <h3 className="mb-5 flex items-center gap-2.5 text-[18px] font-bold text-[#4c1d95]">
                <span className="rounded-[6px] bg-[#ede9fe] px-2 py-1 text-[10.5px] font-bold uppercase tracking-[.08em]">Ahora</span>
                Con Legajo
              </h3>
              <div className="flex flex-col gap-4">
                {["Carpeta digital centralizada y ordenada en la nube.","Acceso controlado y trazable por rol, con historial.","Información disponible en tiempo real para todos.","Proceso de crédito ágil, transparente y auditable."].map((t) => (
                  <div key={t} className="flex items-start gap-3 text-[14.5px] leading-[1.4] text-[#4c1d95]">
                    <span className="mt-0.5 flex h-[38px] w-[38px] shrink-0 items-center justify-center rounded-[10px] bg-[#e9d5ff] text-[#6d28d9]">
      ...
      {/* ── CÓMO FUNCIONA ───────────────────────────────────────────────── */}
      <section id="proceso" className="py-[88px]" style={{ background: "linear-gradient(180deg,#faf8ff,#f0ebff)" }}>
        <div className="mx-auto max-w-[1180px] px-7">
          <motion.div variants={stagger(0.08)} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} className="mb-12 text-center">
            <motion.span variants={fadeUp} className="mb-3.5 inline-block text-[12px] font-bold uppercase tracking-[.12em] text-[#6d28d9]">Proceso</motion.span>
      ...
      <section id="roles" className="bg-white py-[88px]">
        <div className="mx-auto max-w-[1180px] px-7">
          <motion.div variants={stagger(0.08)} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} className="mb-12 text-center">
            <motion.span variants={fadeUp} className="mb-3.5 inline-block text-[12px] font-bold uppercase tracking-[.12em] text-[#6d28d9]">Los 3 actores</motion.span>
          ...
          <motion.div variants={stagger(0.14)} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-60px" }}
            ...
            {[
              { accent: "#6d28d9", iBg: "#f0ebff", iC: "#6d28d9", chk: "#a78bfa", btnBg: "#6d28d9", btnHover: "#4c1d95", btnLabel: "Registrate gratis", rol: "Quien produce", name: "Cliente / Productor", href: "/registro/usuario",
              ...
              { accent: "#312e81", iBg: "#eef2ff", iC: "#312e81", chk: "#4f46e5", btnBg: "#312e81", btnHover: "#1e1b4b", btnLabel: "Solicitar habilitación", rol: "Estudio contable · Requiere habilitación", name: "Contador", href: "/registro/contador",
              ...
              { accent: "#9333ea", iBg: "#f3e8ff", iC: "#7e22ce", chk: "#9333ea", btnBg: "#9333ea", btnHover: "#7e22ce", btnLabel: "Registrate gratis", rol: "Banco / Financiera / Empresa", name: "Entidad Financiera", href: "/registro/entidad",
              ...
              <motion.div key={r.name} variants={fadeUp}
                className="flex flex-col overflow-hidden rounded-[20px] border border-[#ede9fe] bg-white shadow-sm"
                whileHover={{ y: -6, boxShadow: "0 18px 50px rgba(91,33,182,.1),0 6px 16px rgba(91,33,182,.06)" }}
                ...
                {/* CTA por rol */}
                <div className="border-t border-[#ede9fe] px-7 py-5">
                  <Link href={r.href}
      ...
      {/* ── MÉTRICAS ────────────────────────────────────────────────────── */}
      <section id="metricas" className="py-[88px]" style={{ background: "linear-gradient(180deg,#faf8ff,#f0ebff)" }}>
        <div className="mx-auto max-w-[1180px] px-7">
          <motion.div variants={stagger(0.08)} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-80px" }} className="mb-12 text-center">
            <motion.span variants={fadeUp} className="mb-3.5 inline-block text-[12px] font-bold uppercase tracking-[.12em] text-[#6d28d9]">Impacto</motion.span>
          ...
          <motion.div variants={stagger(0.12)} initial="hidden" whileInView="show" viewport={{ once: true, margin: "-60px" }}
            ...
            {[
              { t: -70, pre: "-", suf: "%",  label: "Tiempo en reunir la documentación",    iBg: "#f0ebff", iC: "#6d28d9", vC: "#6d28d9", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/></svg> },
              { t: 3,   pre: "",  suf: "",   label: "Roles conectados en una sola plataforma", iBg: "#eef2ff", iC: "#312e81", vC: "#312e81", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><circle cx="9" cy="8" r="3"/><path d="M3 20a6 6 0 0112 0"/><circle cx="17" cy="9" r="2.4"/><path d="M15 20a5 5 0 016-4.6"/></svg> },
              { t: 100, pre: "",  suf: "%",  label: "Trazabilidad de accesos y autorizaciones", iBg: "#f0ebff", iC: "#6d28d9", vC: "#6d28d9", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="M9 12l2 2 4-4"/></svg> },
              { t: 40,  pre: "+", suf: "%",  label: "Velocidad en la aprobación de créditos",  iBg: "#f3e8ff", iC: "#7e22ce", vC: "#9333ea", icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6"><path d="M3 17l6-6 4 4 7-8"/><path d="M14 7h7v7"/></svg> },
            ].map((k) => (
              <motion.div key={k.label} variants={fadeUp}
                className="rounded-[20px] border border-[#ede9fe] bg-white p-7 text-center shadow-sm"
                whileHover={{ y: -5, boxShadow: "0 12px 32px rgba(91,33,182,.08)" }}
                transition={{ type: "spring", stiffness: 300, damping: 22 }}>
      ...
      <section id="registro" className="py-[88px]">
        <div className="mx-auto max-w-[1180px] px-7">
          <motion.div initial={{ opacity: 0, y: 40, scale: 0.97 }} whileInView={{ opacity: 1, y: 0, scale: 1 }}
            ...
            className="overflow-hidden rounded-[28px] p-14 shadow-[0_18px_50px_rgba(91,33,182,.2)]"
            style={{ background: "radial-gradient(700px 360px at 85% 10%,rgba(139,92,246,.28),transparent 60%),radial-gradient(600px 300px at 10% 90%,rgba(168,85,247,.16),transparent 60%),linear-gradient(135deg,#4c1d95,#312e81)" }}>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              {[
                { rol: "Cliente / Productor", desc: "Autorizo accesos y llevo mi carpeta.", href: "/registro/usuario",
                  bg: "rgba(109,40,217,.55)", border: "rgba(139,92,246,.35)", iconColor: "#a78bfa",
                ...
                { rol: "Contador", desc: "Cargo carpetas de mis clientes. Requiere verificación de la plataforma.", href: "/registro/contador",
                  bg: "rgba(49,46,129,.55)", border: "rgba(79,70,229,.40)", iconColor: "#818cf8",
                ...
                { rol: "Entidad Financiera", desc: "Accedo a carpetas con permiso acotado en tiempo e información.", href: "/registro/entidad",
                  bg: "rgba(147,51,234,.45)", border: "rgba(233,213,255,.35)", iconColor: "#c084fc",
      ...
      {/* ── FOOTER ──────────────────────────────────────────────────────── */}
      <footer className="border-t border-[#ede9fe] bg-white py-10">
        <div className="mx-auto flex max-w-[1180px] flex-wrap items-center justify-between gap-6 px-7">
          <Link href="/" className="flex items-center gap-2.5 text-[16px] font-extrabold tracking-tight text-[#212529]">
            <span className="flex h-8 w-8 items-center justify-center rounded-[9px] text-white" style={{ background: "linear-gradient(135deg,#6d28d9,#312e81)" }}>
          ...
          <div className="flex flex-wrap gap-6">
            {["Privacidad","Términos","Contacto","LinkedIn"].map((l) => (
              <a key={l} href="#" className="text-[13.5px] text-[#5A6470] transition-colors hover:text-[#6d28d9]">{l}</a>
            ))}
          </div>
